...
const edit_movie = () => {
    ...
    row.innerHTML = `
    <td><input type="text" id="edit_title" value="${title}"></td>
    <td class="poster-container">
        <input type="text" id="edit_poster" value="${poster}">
    </td>
    <td><input type="text" id="edit_year" value="${year}"></td>
    <td><input type="text" id="edit_rating" value="${rating}"></td>
    <td><input type="text" id="edit_language" value="${language}"></td>
    <td class="actions">
